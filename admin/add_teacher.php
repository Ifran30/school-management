    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 leftside">
          <ul>
            <li><a href="teacher.php">All Teacher</a></li>
...
<section>
  <div class="container form_edit text-center">
    <form method="POST" action="insertteacher.php">
      ...
      <input type="text" placeholder="Teacher ID" name="tubid"> <br>
       <span>Name:</span>
      <input type="text" placeholder="NAme" name="subsname"> <br>
       <span>phone NO:</span>
      <input type="text" placeholder="phone no"  name="phoneno"> <br>
       <span>Admin ID:</span>
      <input type="text" placeholder="Admin ID"  name="aid"> <br>
      <span>Address:</span>
