    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 leftside">
          <ul>
            <li><a href="subject.php">All Subject</a></li>
...
<section>
  <div class="container form_edit text-center">
    <form method="POST" action="insertsubject.php">
      ...
      <input type="text" placeholder="subject ID" name="subid"> <br>
       <span>Name:</span>
      <input type="text" placeholder="NAme" name="subname"> <br>
       <span>Class:</span>
      <input type="text" placeholder="class"  name="claas"> <br>
       <span>Admin ID:</span>
      <input type="text" placeholder="Admin ID"  name="id"> <br>
