    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 leftside">
          <ul>
            <li><a href="parent.php">All parent</a></li>
            <li><a href="add_parents.php">Add parent</a></li>
            <li><a href="">Delete parent</a></li>
...
<section>
  <div class="container form_edit text-center">
    <form method ="POST" action="insertparents.php">
      <span>Parent ID:</span>
      <input type="text" placeholder="parents ID" name="fmid"> <br>
       <span>Name:</span>
      <input type="text" placeholder="parents NAme" name="pname"> <br>
