    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 leftside">
          <ul>
            <li><a href="assigned_class.php">All Assigned Class</a></li>
            <li><a href="add_assigned_class.php">Add Assigned Class</a></li>
            <li><a href="">Delete Assigned Class</a></li>
...
<section>
  <div class="container form_edit text-center">
    <form method ="POST" action="insertparents.php">
      <span>Class No:</span>
      <input type="text" placeholder="Class NO" name="fmid"> <br>
       <span>Teacher ID:</span>
      <input type="text" placeholder="Teacher ID" name="pname"> <br>
      <button type="submit">Add Assigned Class</button>
    </form>
  </div>
</section>
